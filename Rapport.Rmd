...
```
# Interprétation
Le premier plan factoriel explique 49,85% de la variance.
Les variables age, pregnant dans une moindre mesure triceps, mass sont celles pour lesquelles la longueur de la flèche est la plus importante, donc qui sont le plus représenté dans cette représentation en 2 dimensions. Elles sont toutes les quatre situé au milieu d'un quart de cercle, donc sont autant correlées à la dimension 1 qu'à la dimension 2. 
