...
>>>>>>> 45cc3419e621205973a49369b95dea40d7d77261
```
...
#voir selon la suite si on a besoin de garder les deux versions ou une seule
=======
### Base test
...
$$
diabetes = 0.11*pregnant + 0.036*glucose + 0.0013*pressure + 0.0066*triceps - 9*10^{-4}*insulin + 0.085*mass + 1.2*pedigree + 0.029*age - 10.2 
$$
