...
On commence par **faire une base test indépendante** ie séparer les données en deux sets : training_data et test_data.On va construire le modèle grâce au premier set puis le tester sur le deuxième.
...
Ce qui donne :
$$
\mu = \frac{exp(\beta_0 +\beta_1 x_1 + ... + \beta_k x_k)}{1 + exp(\beta_0 + \beta_1 x_1 + ... + \beta_k x_k)}
