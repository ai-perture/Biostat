...
## 1.1 Représentation des distributions
...
A ce stade, l'accuracy est de presque 75%.
...
model2 <- glmnet(training_data[,2:(NCOL(data)-1)], training_data$diabetes, family = "binomial", alpha = 0.5)
...
cv_model <- cv.glmnet(training_data[,2:(NCOL(data)-1)], training_data$diabetes)
```
